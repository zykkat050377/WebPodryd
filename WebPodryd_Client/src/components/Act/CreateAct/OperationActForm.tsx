// src/components/Act/CreateAct/OperationActForm.tsx
...
const OperationActForm: React.FC<ActFormProps> = ({
  selectedContract,
  actData,
  onWorkServiceChange,
  onAddWorkService,
  ...
  return (
    <Box sx={{ mt: 2 }}>
      <Typography variant="subtitle1" gutterBottom>
        Акт выполненных работ: по договорам "за операцию"
      </Typography>
      ...
      <Table>
        <TableHead>
          <TableRow>
            ...
            <TableCell align="center">Кол-во, опер.</TableCell>
            <TableCell align="center">Ед. изм.</TableCell>
            <TableCell align="right">Цена за операцию, Br</TableCell>
...
export default OperationActForm;