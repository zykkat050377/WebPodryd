// src/components/Act/CreateAct/CostActForm.tsx
...
const CostActForm: React.FC<ActFormProps> = ({
  selectedContract,
  actData,
  onWorkServiceChange,
  onAddWorkService,
  ...
  return (
    <Box sx={{ mt: 2 }}>
      <Typography variant="subtitle1" gutterBottom>
        Акт выполненных работ: по договорам "стоимость"
      </Typography>
      ...
      <Table>
        <TableHead>
          <TableRow>
            ...
            <TableCell align="center">Кол-во, усл.</TableCell>
            <TableCell align="center">Ед. изм.</TableCell>
            <TableCell align="right">Стоимость, Br</TableCell>
