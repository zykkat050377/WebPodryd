// src/components/Contract/ContractGeneralData/OperationPaymentForm.tsx
...
const OperationPaymentForm: React.FC<PaymentFormProps> = ({
  ...
  return (
    <Box sx={{ mt: 2 }}>
      <Typography variant="subtitle1" gutterBottom>
        Оплата труда: по договорам "за операцию"
      </Typography>
      ...
      {selectedWorkServices.map((workService, index) => {
        ...
        return (
          <WorkServiceBlock
            ...
            index={index}
            cost={cost}
            costLabel="Стоимость за операцию"
