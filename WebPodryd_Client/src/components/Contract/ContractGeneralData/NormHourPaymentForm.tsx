// src/components/Contract/ContractGeneralData/NormHourPaymentForm.tsx
...
const NormHourPaymentForm: React.FC<PaymentFormProps> = ({
  ...
  return (
    <Box sx={{ mt: 2 }}>
      <Typography variant="subtitle1" gutterBottom>
        Оплата труда: по договорам "нормо-часа"
      </Typography>
      ...
      {selectedWorkServices.map((workService, index) => {
        ...
        return (
          <WorkServiceBlock
            ...
            index={index}
            cost={cost}
            costLabel="Стоимость нормо-часа"
...
export default NormHourPaymentForm;
