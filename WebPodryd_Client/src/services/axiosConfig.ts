...
//   baseURL: 'http://localhost:29565', // HTTP порт System API
//   headers: {
...
//   baseURL: 'https://localhost:44350', // HTTPS порт Identity API
//   headers: {
//     'Content-Type': 'application/json',
//   },
// });
...
// };
//
// setupResponseInterceptor(systemApi);
// setupResponseInterceptor(identityApi);
//
// // Для обратной совместимости - оставьте основной export
// const api = systemApi;
// export default api;
